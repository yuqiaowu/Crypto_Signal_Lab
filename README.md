...
- `获取数据.py`：拉取 OKX 日线行情并计算布林带、RSI、DMI、ATR% 等指标。执行 `python 获取数据.py` 会生成信号文件 `signals_60d.json`、波动率数据 `atr_metrics.json` 以及图像 `eth_okx_daily.png`、`eth_atr_percent.png`，供 DeepSeek 分析脚本与其它流程引用。
